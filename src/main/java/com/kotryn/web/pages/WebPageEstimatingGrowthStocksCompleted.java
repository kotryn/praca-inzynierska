...
public class WebPageEstimatingGrowthStocksCompleted {
    ...
    public Page show() {
        ...
        body.add(new Entity<>(new Button("button-back", "http://kotryn.localtunnel.me/estimating_growth_stocks_completed_back/"+jobId, "Back")));
        body.add(new Entity<>(new Button("button", "http://kotryn.localtunnel.me/estimating_worst_case_copula_setup/"+jobId, "Next")));
