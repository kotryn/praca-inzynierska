...
public class WebPageBuildingRobustPortfolioSetup {
    ...
    public Page show() {
        ...
        body.add(new Entity<>(new Button("button-back", "http://kotryn.localtunnel.me/building_robust_portfolio_setup_back/"+jobId, "Back")));
        body.add(new Entity<>(new Button("button-form", "http://kotryn.localtunnel.me/building_robust_portfolio/"+jobId, "Next")));
