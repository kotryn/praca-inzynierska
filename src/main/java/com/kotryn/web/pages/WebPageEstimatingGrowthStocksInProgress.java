...
public class WebPageEstimatingGrowthStocksInProgress {
    ...
    public Page show() {
        ...
        body.add(new Entity<>(new Button("button-back", "http://localhost:8080/estimating_growth_stocks_in_progress_back/"+jobId, "Back")));
        body.add(new Entity<>(new Button("button", "http://localhost:8080/estimating_growth_stocks_in_progress/"+jobId, "Refresh")));
