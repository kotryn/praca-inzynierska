...
public class WebPagePromptUser {
    ...
    public Page show() {
        ...
        Button btnNewJob = new Button("button", "http://kotryn.localtunnel.me/begin_job", "Begin a new job");
        Button btnConnectJob = new Button("button", "http://kotryn.localtunnel.me/connect_to_job", "Connect to a job");
        Button btnDeleteJob = new Button("button", "http://kotryn.localtunnel.me/delete_job", "Delete job");
