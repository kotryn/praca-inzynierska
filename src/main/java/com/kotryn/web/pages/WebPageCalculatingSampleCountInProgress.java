...
public class WebPageCalculatingSampleCountInProgress {
    ...
    public Page show() {
        ...
        body.add(new Entity<>(new Button("button-back", "http://kotryn.localtunnel.me/calculating_sample_count_in_progress_back/"+jobId, "Back")));
        body.add(new Entity<>(new Button("button", "http://kotryn.localtunnel.me/calculating_sample_count_in_progress/"+jobId, "Refresh")));
