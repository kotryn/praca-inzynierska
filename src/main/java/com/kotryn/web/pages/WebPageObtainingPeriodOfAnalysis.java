...
public class WebPageObtainingPeriodOfAnalysis {
    ...
    public Page show() {
        ...
        body.add(new Entity<>(new Button("button-form", "http://kotryn.localtunnel.me/job_set_date/"+jobId, "Submit")));
        body.add(new Entity<>(new Button("button", "http://kotryn.localtunnel.me/period_of_analysis/"+jobId, "Next")));
