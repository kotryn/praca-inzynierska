...
public class WebPagePromptUser {
    ...
    public Page show() {
        ...
        Button btnNewJob = new Button("button", "http://Lenovo-320:8081//begin_job", "Begin a new job");
        Button btnConnectJob = new Button("button", "http://Lenovo-320:8081//connect_to_job", "Connect to a job");
        Button btnDeleteJob = new Button("button", "http://Lenovo-320:8081//delete_job", "Delete job");
