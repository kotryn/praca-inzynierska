...
public class WebPageBuildingRobustPortfolioSetup {
    ...
    public Page show() {
        ...
        body.add(new Entity<>(new Button("button-back", "http://192.168.31.106:8081//building_robust_portfolio_setup_back/"+jobId, "Back")));
        body.add(new Entity<>(new Button("button-form", "http://192.168.31.106:8081//building_robust_portfolio/"+jobId, "Next")));
