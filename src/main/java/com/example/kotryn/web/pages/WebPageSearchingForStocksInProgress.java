...
public class WebPageSearchingForStocksInProgress {
    ...
    public Page show() {
        ...
        body.add(new Entity<>(new Button("button-back", "http://Lenovo-320:8081//stocks_search_in_progress_back/"+jobId, "Back")));
        body.add(new Entity<>(new Button("button", "http://Lenovo-320:8081//stocks_search_in_progress/"+jobId, "Refresh")));
