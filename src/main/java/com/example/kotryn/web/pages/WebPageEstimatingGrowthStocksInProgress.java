...
public class WebPageEstimatingGrowthStocksInProgress {
    ...
    public Page show() {
        ...
        body.add(new Entity<>(new Button("button-back", "http://192.168.31.106:8081//estimating_growth_stocks_in_progress_back/"+jobId, "Back")));
        body.add(new Entity<>(new Button("button", "http://192.168.31.106:8081//estimating_growth_stocks_in_progress/"+jobId, "Refresh")));
