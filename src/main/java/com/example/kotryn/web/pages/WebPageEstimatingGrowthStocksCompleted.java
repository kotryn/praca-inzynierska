...
public class WebPageEstimatingGrowthStocksCompleted {
    ...
    public Page show() {
        ...
        body.add(new Entity<>(new Button("button-back", "http://Lenovo-320:8081//estimating_growth_stocks_completed_back/"+jobId, "Back")));
        body.add(new Entity<>(new Button("button", "http://Lenovo-320:8081//estimating_worst_case_copula_setup/"+jobId, "Next")));
