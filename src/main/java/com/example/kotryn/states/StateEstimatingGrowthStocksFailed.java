...
public class StateEstimatingGrowthStocksFailed extends StateBase implements IState {
    ...
    public StateEstimatingGrowthStocksFailed(JobRepository jobRepository, ContextRepository contextRepository) {
    ...
    private void saveEmptySetOfStocks(WebDataEstimatingGrowthStocksFailed input) {
